...
export const SkullIcon = ({ className = "w-4 h-4" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2c-4.42 0-8 3.58-8 8 0 1.57.46 3.03 1.24 4.26L4 21h16l-1.24-6.74c.78-1.23 1.24-2.69 1.24-4.26 0-4.42-3.58-8-8-8zm-3 8c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm6 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-3 8c-1.66 0-3-1.34-3-3h6c0 1.66-1.34 3-3 3z"/>
  </svg>
)
